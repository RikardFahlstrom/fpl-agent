...
# Read-only, and writes exactly one file: logs/gwNN.md, which is tracked. Separate from
# `deadline` because the brief is what a person reads, and a person is not always there
