...
status: applied
action: BONUS_PRIOR_APPEARANCES 3.0 -> 1.0 (bonus damping toward zero was halving starters' bonus), model 0.5.1; goals-conceded term E[floor(X/2)] instead of X/2, model 0.5.2
---
